...
pacman_list="sudo pacman -S --needed --noconfirm alacritty btop discord discover fastfetch firefox flatpak git grub-customizer htop linux-lts linux-lts-headers linux-zen linux-zen-headers lutris nvidia-dkms nvidia-utils lib32-nvidia-utils qbittorrent starship steam-native-runtime thunderbird timeshift vlc wine wine-gecko wine-mono winetricks"
