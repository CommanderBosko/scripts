...
INSTALL_CMD="sudo pacman -S --needed --noconfirm linux-zen linux-zen-headers linux-lts linux-lts-headers nvidia-dkms nvidia-utils lib32-nvidia-utils grub-customizer alacritty firefox discord steam wine winetricks lutris discover"
