...
pacman_list="sudo pacman -S --needed --noconfirm alacritty discord discover fastfetch firefox flatpak git grub-customizer linux-lts linux-lts-headers linux-zen linux-zen-headers lutris nvidia-dkms nvidia-utils lib32-nvidia-utils steam-native-runtime wine wine-gecko wine-mono winetricks"
